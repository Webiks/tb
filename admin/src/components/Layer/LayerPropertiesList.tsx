...
const LayerPropertiesList: IPropertiesList[] = [
    ...
    { label: 'Layer Date Upload', path: 'worldLayer.date', type: 'date', readonly: true },
    { label: 'File Date Modified', path: 'worldLayer.imageData.file.dateModified', type: 'date', readonly: false },
