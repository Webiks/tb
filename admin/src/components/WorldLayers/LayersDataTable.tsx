    ...
    actionsButtons = (rowData: any, column: any) => {
        return (
            <div className="ui-button-icon ui-helper-clearfix">
                <Tooltip for={['#preview', '#edit', '#delete']} title={this.state.title}
                         tooltipPosition={this.state.tooltipPosition}
                         onBeforeShow={(e) => this.onTooltipPosition(e)}/>
                <Button type="button" id="preview" icon="fa fa-search" className="ui-button-success"
                ...
                <Button type="button" id="edit" icon="fa fa-edit" className="ui-button-warning"
                        style={{ margin: '3px 7px' }}
            ...
            <div className="content-section implementation">
                {
                    ...
                    <div>
                        <DataTable value={this.props.layers} paginator={true} rows={30} responsive={false}
                            ...
                            <Column field="inputData.fileName" header="Name" sortable={true}
                                    style={{ textAlign: 'left', padding: '7px 20px' }}/>
                            ...
                            <Column field="fileData.fileExtension" header="Extension" sortable={true}
                                    style={{ width: '12%' }}/>
                            <Column field="fileData.fileCreatedDate" header="File Created" sortable={true}
                                    style={{ width: '12%' }}/>
                            <Column field="fileData.fileUploadDate" header="Layer Upload" sortable={true}
                                    style={{ width: '12%' }}/>
                            <Column field="inputData.affiliation" header="File Affiliation" sortable={true}
                                    style={{ width: '10%' }}/>
