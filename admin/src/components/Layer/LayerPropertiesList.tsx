...
const LayerPropertiesList: IPropertiesList[] = [
    ...
    { label: 'File Size(KB)', path:'worldLayer.imageData.file.size' , readonly: true },
    { label: 'Folder Path', path: 'worldLayer.layer.filePath', readonly: true },
    { label: 'Image Date Taken', path: 'worldLayer.imageData.file.dateCreated', type: 'date', readonly: false },
    { label: 'Image Last Modified', path: 'worldLayer.imageData.file.dateModified', type: 'date', readonly: false },
