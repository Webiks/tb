...
- [Proxying API Requests in Development](#proxying-api-requests-in-development)
  - ["Invalid Host DataTableHeader" Errors After Configuring Proxy](#invalid-host-header-errors-after-configuring-proxy)
...
### "Invalid Host DataTableHeader" Errors After Configuring Proxy
...
```json
  "homepage": "https://myusername.github.io/terra-admin-app",
```
...
To publish it at [https://myusername.github.io/terra-admin-app](https://myusername.github.io/terra-admin-app), run:
