...
class WorldsDataTable extends React.Component {
    ...
    delete = () => {
        WorldService.deleteWorld(this.state.selectedWorld._id)
            .then(res => {
                const worlds =
    ...
    actionsButtons = (rowData: any, column: any) => {
        return (
            <div className="ui-button-icon ui-helper-clearfix" onClick={($event) => $event.stopPropagation()}>
                <Tooltip for={['#edit', '#delete']} title={this.state.title}
            ...
            <div className="content-section implementation">
                {
                    ...
                    <div>
                        <DataTable id="dataTable" value={this.props.worldsList} paginator={true} rows={30}
                                   responsive={true}
                            ...
                            <Column className="name" field="name" header="Name" sortable={true}
                                    style={{ textAlign: 'left', padding: '7px 20px', width: '20%' }}/>
